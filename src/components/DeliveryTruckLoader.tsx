...
export default function DeliveryTruckLoader() {
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex flex-col items-center justify-center p-4 animate-in fade-in zoom-in duration-300">
...
h78.747C231.693,100.736,232.77,106.162,232.77,111.694z"></path>
      ...
      <h2 className="mt-16 text-xl font-outfit font-black uppercase text-emerald-400 tracking-widest animate-pulse drop-shadow-md">Confirming Secure Payment...</h2>
      <p className="text-gray-400 mt-2 text-xs uppercase tracking-widest text-center max-w-sm">Please do not refresh the page while we allocate your poster order to the nearest warehouse.</p>
    </div>
  );
}
