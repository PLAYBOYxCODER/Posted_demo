...
const MergedPlanes = forwardRef(({ material, width, count, height }: { material: any, width: number, count: number, height: number }, ref) => {
...
const PlaneNoise = forwardRef((props: { material: any, width: number, count: number, height: number }, ref) => (
